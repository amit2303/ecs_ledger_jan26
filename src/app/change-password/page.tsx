...
export default function ChangePasswordPage() {
    ...
    return (
        <div className="p-5">
            <div className="mb-6">
                <Link href="/" className="inline-flex items-center text-gray-500 hover:text-ecs-blue transition-colors mb-4">
                    <ArrowLeft className="w-4 h-4 mr-1" />
                    Back
                </Link>
                <h1 className="text-2xl font-bold text-gray-900">Update Credentials</h1>
                <p className="text-sm text-gray-500 mt-1">Change your username or password</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 max-w-sm">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 bg-ecs-blue text-white font-bold rounded-xl shadow-lg active:scale-95 transition-transform disabled:opacity-50 mt-4"
                >
